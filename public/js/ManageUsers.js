...
for ( i=0;i<30;i++)
        $('.list').append('<li class="order col-lg-12 item'+i+'"><a href="UserDetail.html" class="col-lg-6"><p>UserID : USER000'+i+
            '- user_name: Khang Duy - email: khangduyth@gmail.com</p>   </a> <div class="col-lg-6"> <button id="btn'+i+'" class="btn btn-danger">delete</button></div></li>');
