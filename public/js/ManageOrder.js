...
for (i=0;i<30;i++){
	 if (i<29)
	 $('#container .list').append('<li class="order col-lg-12 item'+i+'" > <a href="OrderDetail.html" class="col-lg-6"> <p>OrderId: ORD280420170'+i+' - Product name: light'+i+' - date:28/4/2017</p> 	</a><div class="col-lg-6"> 	<button id="btn'+i+'" class="btn btn-danger">delete</button> </div> </li>');
